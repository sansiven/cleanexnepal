  ...
  return (
    <>
      ...
      <main className="profile-page">
        ...
        <section className="relative py-16 bg-blueGray-200 mb-36 bhattey">
          <div className="container mx-auto px-4">
            <div className="relative flex flex-row min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
              <div className="md:w-1/3 sm:w-1/3 px-6 ">
                ...
                <div className="text-center mt-12">
                  ...
                  <div className="mb-2 text-blueGray-600 mt-10">
                    ...
                    CoFounder - Trident Manufacturers
                  </div>
        ...
        <section className="relative py-16 bg-blueGray-200 kaku">
        ...
        <section className="relative py-16 bg-blueGray-200 mb-36 mama">
          <div className="container mx-auto px-4">
            <div className="relative flex flex-row min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
              <div className="md:w-1/3 sm:w-1/3 px-6 ">
                <div className="flex flex-wrap justify-center">
